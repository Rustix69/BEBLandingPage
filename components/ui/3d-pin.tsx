    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-2xl shadow-md bg-gray-50 border border-gray-200 group-hover/pin:border-gray-300 transition duration-700 overflow-hidden w-full"
        >
